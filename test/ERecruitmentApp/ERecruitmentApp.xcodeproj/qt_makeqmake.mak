...
QMAKE    = /usr/bin/qmake
ERecruitmentApp.xcodeproj/project.pbxproj: ERecruitmentApp.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		...
		/usr/local/Qt4.8/mkspecs/features/uitools.prf \
	...
	$(QMAKE) -o ERecruitmentApp.xcodeproj/project.pbxproj ERecruitmentApp.pro
