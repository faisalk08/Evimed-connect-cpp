...
QMAKE    = /usr/bin/qmake
exampleUI.xcodeproj/project.pbxproj: exampleUI.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o exampleUI.xcodeproj/project.pbxproj exampleUI.pro
